...
//		return null; // REMOVE; USED SO THIS FILE COMPILES
	...
	public static double getHighestSalary(Employee[]  array)  {
		...
		double highestSalary = array[0].getSalary();
	...
	public static String displayAll(Employee[]  array)  {
		...
		// 	displayAll += array[i].toString()+"\n";
		// }
		// displayAll += array[array.length-1].toString();
		return displayAll; // REMOVE; USED SO THIS FILE COMPILES
	}
}